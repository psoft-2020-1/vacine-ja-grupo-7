...
public class CidadaoServiceImpl implements CidadaoService {
	...
	public Cidadao atualizarCidadao(CidadaoUpdateDTO cidadaoUpdateDTO) {
		...
		Optional<RegistroVacinacao> registroVacinacao = registroRepository
				.findById(optionalCidadao.get().getRegistroVacinacao().getNumeroCartaoSus());
	...
	private void validaCidadaoDTOSemCpf(CidadaoDTO cidadaoDTO) {
		if ((cidadaoDTO.getIdade() == null || cidadaoDTO.getIdade() <= 0)
				|| (cidadaoDTO.getCpf() == null || cidadaoDTO.getCpf().equals(""))
	...
	private void validaCidadaoDTOSemCpf(CidadaoUpdateDTO cidadaoUpdateDTO) {
		if ((cidadaoUpdateDTO.getIdade() == null || cidadaoUpdateDTO.getIdade() <= 0)
				|| (cidadaoUpdateDTO.getCpf() == null || cidadaoUpdateDTO.getCpf().equals(""))
				|| (cidadaoUpdateDTO.getEndereco() == null || cidadaoUpdateDTO.getEndereco().equals(""))
				|| (cidadaoUpdateDTO.getNome() == null || cidadaoUpdateDTO.getNome().equals(""))
				|| cidadaoUpdateDTO.getDataNascimento() == null
				|| (cidadaoUpdateDTO.getProfissao() == null || cidadaoUpdateDTO.getProfissao().equals(""))
				|| (cidadaoUpdateDTO.getTelefone() == null || cidadaoUpdateDTO.getTelefone().equals(""))) {
			throw new CidadaoInvalidoException("ErroValidaCidadão: Todos os campos devem ser preenchidos.");
		}
	}
